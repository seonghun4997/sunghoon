...
export const DEFAULT_CONFIG = {
  ...
  welcomeSms: "[전성훈 상태창] [이름]님, 구독 등록이 완료됐습니다! 앞으로 사업·네트워킹 소식을 보내드릴게요.",
...
export function mergeConfig(saved) {
  ...
  return {
    ...
    welcomeSms: typeof saved.welcomeSms === "string" && saved.welcomeSms.trim() ? saved.welcomeSms : DEFAULT_CONFIG.welcomeSms,
