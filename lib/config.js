...
export const DEFAULT_CONFIG = {
  ...
  texts: {
    ...
    subTitle: "📡 구독하고 소식 받기",
    subDesc: "새 사업 소식과 인맥 업데이트를 문자로 보내드립니다. 신청 후 구독자로 등록됩니다.",
    ...
    lockNetDesc: "인맥 소개 요청은 구독 후 가능합니다. 구독하면 소개 요청 방법을 안내드립니다.",
    lockBtn: "📡 구독하고 열기",
    netEmpty: "빈 슬롯 — 현재 모집중",
    // ★ v42 등급별 공개
    bizGateDesc: "운영 사업 목록은 구독자부터 공개됩니다.",
    netGateDesc: "인맥도는 구독자부터 공개됩니다.",
    gateSubBtn: "📡 구독하고 열기",
    ...
    lockNet3Desc: "인맥 소개 신청은 사적으로 3회 이상 만난 분들부터 가능합니다. 먼저 커피챗을 제안해주세요!",
...
const LEGACY_TEXTS = {
  ...
  netGateDesc: ["인맥도는 구독자(4촌)부터 공개됩니다."],
  ...
  lockNet3Desc: ["인맥 소개 신청은 3촌(사적으로 3회 이상 만난 사이)부터 가능합니다. 먼저 커피챗을 제안해주세요!", "인맥 소개 신청은 3촌(사적으로 3회 이상 만난 사이)부터 가능합니다. 먼저 미팅을 제안해주세요!"],
};
