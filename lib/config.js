...
export const DEFAULT_CONFIG = {
  ...
  texts: {
    ...
    subDesc: "새 사업 소식과 인맥 업데이트를 문자로 보내드립니다. 신청하면 바로 4촌으로 등록됩니다.",
...
const LEGACY_TEXTS = {
  ...
  lockNet3Desc: [
    "인맥 소개 신청은 3촌(사적으로 3회 이상 만난 사이)부터 가능합니다. 먼저 미팅을 제안해주세요!",
  ],
};
